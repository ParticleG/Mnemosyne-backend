...
class Ebooks
{
  public:
     ...
     */
    explicit Ebooks(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Ebooks(const Json::Value &pJson) noexcept(false);
     ...
     */
    Ebooks(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Ebooks>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Ebooks>;
#endif
