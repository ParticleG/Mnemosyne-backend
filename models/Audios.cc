...
const std::string Audios::Cols::_id = "id";
const std::string Audios::Cols::_format = "format";
const std::string Audios::Cols::_name = "name";
const std::string Audios::Cols::_tags = "tags";
const std::string Audios::Cols::_keywords = "keywords";
const std::string Audios::Cols::_data = "data";
const std::string Audios::Cols::_uploader = "uploader";
const std::string Audios::Cols::_collection = "collection";
const std::string Audios::primaryKeyName = "";
const bool Audios::hasPrimaryKey = false;
const std::string Audios::tableName = "audios";

const std::vector<typename Audios::MetaData> Audios::metaData_={
...
const std::string &Audios::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
Audios::Audios(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
...
Audios::Audios(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
Audios::Audios(const Json::Value &pJson) noexcept(false)
{
...
void Audios::updateByMasqueradedJson(const Json::Value &pJson,
...
void Audios::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
const int32_t &Audios::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t> &Audios::getId() const noexcept
{
    return id_;
}
void Audios::setId(const int32_t &pId) noexcept
{
    id_ = std::make_shared<int32_t>(pId);
    dirtyFlag_[0] = true;
}

const std::string &Audios::getValueOfFormat() const noexcept
{
...
const std::shared_ptr<std::string> &Audios::getFormat() const noexcept
{
    return format_;
}
void Audios::setFormat(const std::string &pFormat) noexcept
{
    format_ = std::make_shared<std::string>(pFormat);
    dirtyFlag_[1] = true;
}
void Audios::setFormat(std::string &&pFormat) noexcept
{
    format_ = std::make_shared<std::string>(std::move(pFormat));
    dirtyFlag_[1] = true;
}
void Audios::setFormatToNull() noexcept
{
    format_.reset();
    dirtyFlag_[1] = true;
}

const std::string &Audios::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Audios::getName() const noexcept
{
    return name_;
}
void Audios::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[2] = true;
}
void Audios::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[2] = true;
}
void Audios::setNameToNull() noexcept
{
    name_.reset();
    dirtyFlag_[2] = true;
}

const std::string &Audios::getValueOfTags() const noexcept
{
    const static std::string defaultValue = std::string();
    if(tags_)
        return *tags_;
...
const std::shared_ptr<std::string> &Audios::getTags() const noexcept
{
    return tags_;
}
void Audios::setTags(const std::string &pTags) noexcept
{
    tags_ = std::make_shared<std::string>(pTags);
    dirtyFlag_[3] = true;
}
void Audios::setTags(std::string &&pTags) noexcept
{
    tags_ = std::make_shared<std::string>(std::move(pTags));
    dirtyFlag_[3] = true;
}
void Audios::setTagsToNull() noexcept
{
    tags_.reset();
    dirtyFlag_[3] = true;
}

const std::string &Audios::getValueOfKeywords() const noexcept
{
    const static std::string defaultValue = std::string();
    if(keywords_)
        return *keywords_;
...
const std::shared_ptr<std::string> &Audios::getKeywords() const noexcept
{
    return keywords_;
}
void Audios::setKeywords(const std::string &pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(pKeywords);
    dirtyFlag_[4] = true;
}
void Audios::setKeywords(std::string &&pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(std::move(pKeywords));
    dirtyFlag_[4] = true;
}
void Audios::setKeywordsToNull() noexcept
{
    keywords_.reset();
    dirtyFlag_[4] = true;
}

const std::string &Audios::getValueOfData() const noexcept
{
    const static std::string defaultValue = std::string();
    if(data_)
        return *data_;
...
const std::shared_ptr<std::string> &Audios::getData() const noexcept
{
    return data_;
}
void Audios::setData(const std::string &pData) noexcept
{
    data_ = std::make_shared<std::string>(pData);
    dirtyFlag_[5] = true;
}
void Audios::setData(std::string &&pData) noexcept
{
    data_ = std::make_shared<std::string>(std::move(pData));
    dirtyFlag_[5] = true;
}
void Audios::setDataToNull() noexcept
{
    data_.reset();
    dirtyFlag_[5] = true;
}

const int32_t &Audios::getValueOfUploader() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(uploader_)
        return *uploader_;
...
const std::shared_ptr<int32_t> &Audios::getUploader() const noexcept
{
    return uploader_;
}
void Audios::setUploader(const int32_t &pUploader) noexcept
{
    uploader_ = std::make_shared<int32_t>(pUploader);
    dirtyFlag_[6] = true;
}
void Audios::setUploaderToNull() noexcept
{
    uploader_.reset();
    dirtyFlag_[6] = true;
}

const int32_t &Audios::getValueOfCollection() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(collection_)
        return *collection_;
...
const std::shared_ptr<int32_t> &Audios::getCollection() const noexcept
{
    return collection_;
}
void Audios::setCollection(const int32_t &pCollection) noexcept
{
    collection_ = std::make_shared<int32_t>(pCollection);
    dirtyFlag_[7] = true;
}
void Audios::setCollectionToNull() noexcept
{
    collection_.reset();
    dirtyFlag_[7] = true;
}

void Audios::updateId(const uint64_t id)
{
}

const std::vector<std::string> &Audios::insertColumns() noexcept
{
...
void Audios::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getFormat())
...
const std::vector<std::string> Audios::updateColumns() const
{
...
void Audios::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getFormat())
...
Json::Value Audios::toJson() const
{
    Json::Value ret;
    if(getId())
    {
...
Json::Value Audios::toMasqueradedJson(
...
bool Audios::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Audios::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Audios::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Audios::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                              const std::vector<std::string> &pMasqueradingVector,
                                              std::string &err)
{
    if(pMasqueradingVector.size() != 8)
...
bool Audios::validJsonOfField(size_t index,
