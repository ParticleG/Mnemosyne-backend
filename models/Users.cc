...
const std::string &Users::getValueOfPermission() const noexcept
{
    const static std::string defaultValue = std::string();
    if(permission_)
        return *permission_;
...
const std::shared_ptr<std::string> &Users::getPermission() const noexcept
{
    return permission_;
}
void Users::setPermission(const std::string &pPermission) noexcept
{
    permission_ = std::make_shared<std::string>(pPermission);
    dirtyFlag_[2] = true;
}
void Users::setPermission(std::string &&pPermission) noexcept
{
