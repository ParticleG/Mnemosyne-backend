...
class User
{
  public:
    ...
    const std::string &getValueOfFollowing() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getFollowing() const noexcept;
    ///Set the value of the column following
    void setFollowing(const std::string &pFollowing) noexcept;
    void setFollowing(std::string &&pFollowing) noexcept;
    ...
    const std::string &getValueOfFollowers() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getFollowers() const noexcept;
    ///Set the value of the column followers
    void setFollowers(const std::string &pFollowers) noexcept;
    void setFollowers(std::string &&pFollowers) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> following_;
    std::shared_ptr<std::string> followers_;
