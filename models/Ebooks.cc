...
const std::string Ebooks::Cols::_id = "id";
const std::string Ebooks::Cols::_format = "format";
const std::string Ebooks::Cols::_name = "name";
const std::string Ebooks::Cols::_tags = "tags";
const std::string Ebooks::Cols::_keywords = "keywords";
const std::string Ebooks::Cols::_data = "data";
const std::string Ebooks::Cols::_uploader = "uploader";
const std::string Ebooks::Cols::_collection = "collection";
const std::string Ebooks::primaryKeyName = "";
const bool Ebooks::hasPrimaryKey = false;
const std::string Ebooks::tableName = "ebooks";

const std::vector<typename Ebooks::MetaData> Ebooks::metaData_={
...
const std::string &Ebooks::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
Ebooks::Ebooks(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
...
Ebooks::Ebooks(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
Ebooks::Ebooks(const Json::Value &pJson) noexcept(false)
{
...
void Ebooks::updateByMasqueradedJson(const Json::Value &pJson,
...
void Ebooks::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
const int32_t &Ebooks::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t> &Ebooks::getId() const noexcept
{
    return id_;
}
void Ebooks::setId(const int32_t &pId) noexcept
{
    id_ = std::make_shared<int32_t>(pId);
    dirtyFlag_[0] = true;
}

const std::string &Ebooks::getValueOfFormat() const noexcept
{
...
const std::shared_ptr<std::string> &Ebooks::getFormat() const noexcept
{
    return format_;
}
void Ebooks::setFormat(const std::string &pFormat) noexcept
{
    format_ = std::make_shared<std::string>(pFormat);
    dirtyFlag_[1] = true;
}
void Ebooks::setFormat(std::string &&pFormat) noexcept
{
    format_ = std::make_shared<std::string>(std::move(pFormat));
    dirtyFlag_[1] = true;
}
void Ebooks::setFormatToNull() noexcept
{
    format_.reset();
    dirtyFlag_[1] = true;
}

const std::string &Ebooks::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Ebooks::getName() const noexcept
{
    return name_;
}
void Ebooks::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[2] = true;
}
void Ebooks::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[2] = true;
}
void Ebooks::setNameToNull() noexcept
{
    name_.reset();
    dirtyFlag_[2] = true;
}

const std::string &Ebooks::getValueOfTags() const noexcept
{
    const static std::string defaultValue = std::string();
    if(tags_)
        return *tags_;
...
const std::shared_ptr<std::string> &Ebooks::getTags() const noexcept
{
    return tags_;
}
void Ebooks::setTags(const std::string &pTags) noexcept
{
    tags_ = std::make_shared<std::string>(pTags);
    dirtyFlag_[3] = true;
}
void Ebooks::setTags(std::string &&pTags) noexcept
{
    tags_ = std::make_shared<std::string>(std::move(pTags));
    dirtyFlag_[3] = true;
}
void Ebooks::setTagsToNull() noexcept
{
    tags_.reset();
    dirtyFlag_[3] = true;
}

const std::string &Ebooks::getValueOfKeywords() const noexcept
{
    const static std::string defaultValue = std::string();
    if(keywords_)
        return *keywords_;
...
const std::shared_ptr<std::string> &Ebooks::getKeywords() const noexcept
{
    return keywords_;
}
void Ebooks::setKeywords(const std::string &pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(pKeywords);
    dirtyFlag_[4] = true;
}
void Ebooks::setKeywords(std::string &&pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(std::move(pKeywords));
    dirtyFlag_[4] = true;
}
void Ebooks::setKeywordsToNull() noexcept
{
    keywords_.reset();
    dirtyFlag_[4] = true;
}

const std::string &Ebooks::getValueOfData() const noexcept
{
    const static std::string defaultValue = std::string();
    if(data_)
        return *data_;
...
const std::shared_ptr<std::string> &Ebooks::getData() const noexcept
{
    return data_;
}
void Ebooks::setData(const std::string &pData) noexcept
{
    data_ = std::make_shared<std::string>(pData);
    dirtyFlag_[5] = true;
}
void Ebooks::setData(std::string &&pData) noexcept
{
    data_ = std::make_shared<std::string>(std::move(pData));
    dirtyFlag_[5] = true;
}
void Ebooks::setDataToNull() noexcept
{
    data_.reset();
    dirtyFlag_[5] = true;
}

const int32_t &Ebooks::getValueOfUploader() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(uploader_)
        return *uploader_;
...
const std::shared_ptr<int32_t> &Ebooks::getUploader() const noexcept
{
    return uploader_;
}
void Ebooks::setUploader(const int32_t &pUploader) noexcept
{
    uploader_ = std::make_shared<int32_t>(pUploader);
    dirtyFlag_[6] = true;
}
void Ebooks::setUploaderToNull() noexcept
{
    uploader_.reset();
    dirtyFlag_[6] = true;
}

const int32_t &Ebooks::getValueOfCollection() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(collection_)
        return *collection_;
...
const std::shared_ptr<int32_t> &Ebooks::getCollection() const noexcept
{
    return collection_;
}
void Ebooks::setCollection(const int32_t &pCollection) noexcept
{
    collection_ = std::make_shared<int32_t>(pCollection);
    dirtyFlag_[7] = true;
}
void Ebooks::setCollectionToNull() noexcept
{
    collection_.reset();
    dirtyFlag_[7] = true;
}

void Ebooks::updateId(const uint64_t id)
{
}

const std::vector<std::string> &Ebooks::insertColumns() noexcept
{
...
void Ebooks::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getFormat())
...
const std::vector<std::string> Ebooks::updateColumns() const
{
...
void Ebooks::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getFormat())
...
Json::Value Ebooks::toJson() const
{
    Json::Value ret;
    if(getId())
    {
...
Json::Value Ebooks::toMasqueradedJson(
...
bool Ebooks::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Ebooks::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Ebooks::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Ebooks::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                              const std::vector<std::string> &pMasqueradingVector,
                                              std::string &err)
{
    if(pMasqueradingVector.size() != 8)
...
bool Ebooks::validJsonOfField(size_t index,
