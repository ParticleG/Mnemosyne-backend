...
const std::string Videos::Cols::_name = "name";
const std::string Videos::Cols::_tags = "tags";
const std::string Videos::Cols::_keywords = "keywords";
const std::string Videos::Cols::_data = "data";
const std::string Videos::Cols::_uploader = "uploader";
const std::string Videos::Cols::_collection = "collection";
const std::string Videos::primaryKeyName = "";
const bool Videos::hasPrimaryKey = false;
...
const int32_t &Videos::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t> &Videos::getId() const noexcept
{
    return id_;
}
void Videos::setId(const int32_t &pId) noexcept
{
...
const std::string &Videos::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Videos::getName() const noexcept
{
    return name_;
}
void Videos::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[2] = true;
}
void Videos::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[2] = true;
}
void Videos::setNameToNull() noexcept
{
    name_.reset();
    dirtyFlag_[2] = true;
}
...
const std::string &Videos::getValueOfKeywords() const noexcept
{
    const static std::string defaultValue = std::string();
    if(keywords_)
        return *keywords_;
...
const std::shared_ptr<std::string> &Videos::getKeywords() const noexcept
{
    return keywords_;
}
void Videos::setKeywords(const std::string &pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(pKeywords);
    dirtyFlag_[4] = true;
}
void Videos::setKeywords(std::string &&pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(std::move(pKeywords));
    dirtyFlag_[4] = true;
}
void Videos::setKeywordsToNull() noexcept
{
    keywords_.reset();
    dirtyFlag_[4] = true;
}

const std::string &Videos::getValueOfData() const noexcept
{
    const static std::string defaultValue = std::string();
    if(data_)
        return *data_;
...
const std::shared_ptr<std::string> &Videos::getData() const noexcept
{
    return data_;
}
void Videos::setData(const std::string &pData) noexcept
{
    data_ = std::make_shared<std::string>(pData);
    dirtyFlag_[5] = true;
}
void Videos::setData(std::string &&pData) noexcept
{
    data_ = std::make_shared<std::string>(std::move(pData));
    dirtyFlag_[5] = true;
}
void Videos::setDataToNull() noexcept
{
    data_.reset();
    dirtyFlag_[5] = true;
}

const int32_t &Videos::getValueOfUploader() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(uploader_)
        return *uploader_;
...
const std::shared_ptr<int32_t> &Videos::getUploader() const noexcept
{
    return uploader_;
}
void Videos::setUploader(const int32_t &pUploader) noexcept
{
    uploader_ = std::make_shared<int32_t>(pUploader);
    dirtyFlag_[6] = true;
}
void Videos::setUploaderToNull() noexcept
{
    uploader_.reset();
    dirtyFlag_[6] = true;
}

const int32_t &Videos::getValueOfCollection() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(collection_)
        return *collection_;
...
const std::shared_ptr<int32_t> &Videos::getCollection() const noexcept
{
    return collection_;
}
void Videos::setCollection(const int32_t &pCollection) noexcept
{
    collection_ = std::make_shared<int32_t>(pCollection);
    dirtyFlag_[7] = true;
}
void Videos::setCollectionToNull() noexcept
{
    collection_.reset();
    dirtyFlag_[7] = true;
}
