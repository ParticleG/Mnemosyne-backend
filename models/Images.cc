...
const std::string Images::Cols::_format = "format";
const std::string Images::Cols::_name = "name";
const std::string Images::Cols::_tags = "tags";
const std::string Images::Cols::_keywords = "keywords";
const std::string Images::Cols::_uuid = "uuid";
const std::string Images::Cols::_uploader = "uploader";
const std::string Images::Cols::_collection = "collection";
...
{"format","std::string","text",0,0,0,1},
{"name","std::string","text",0,0,0,1},
{"tags","std::string","text",0,0,0,1},
{"keywords","std::string","text",0,0,0,1},
{"uuid","std::string","text",0,0,0,0},
{"uploader","int32_t","integer",4,0,0,0},
{"collection","int32_t","integer",4,0,0,1}
};
...
Images::Images(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[5].empty() && pJson.isMember(pMasqueradingVector[5]))
    {
        ...
        {
            uuid_=std::make_shared<std::string>(pJson[pMasqueradingVector[5]].asString());
        }
    }
...
const int32_t &Images::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t> &Images::getId() const noexcept
{
    return id_;
}
void Images::setId(const int32_t &pId) noexcept
{
...
const std::string &Images::getValueOfFormat() const noexcept
{
...
const std::shared_ptr<std::string> &Images::getFormat() const noexcept
{
    return format_;
}
void Images::setFormat(const std::string &pFormat) noexcept
{
    format_ = std::make_shared<std::string>(pFormat);
    dirtyFlag_[1] = true;
}
void Images::setFormat(std::string &&pFormat) noexcept
{
    format_ = std::make_shared<std::string>(std::move(pFormat));
    dirtyFlag_[1] = true;
}

const std::string &Images::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Images::getName() const noexcept
{
    return name_;
}
void Images::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[2] = true;
}
void Images::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[2] = true;
}

const std::string &Images::getValueOfTags() const noexcept
{
    const static std::string defaultValue = std::string();
    if(tags_)
        return *tags_;
...
const std::shared_ptr<std::string> &Images::getTags() const noexcept
{
    return tags_;
}
void Images::setTags(const std::string &pTags) noexcept
{
    tags_ = std::make_shared<std::string>(pTags);
    dirtyFlag_[3] = true;
}
void Images::setTags(std::string &&pTags) noexcept
{
    tags_ = std::make_shared<std::string>(std::move(pTags));
    dirtyFlag_[3] = true;
}

const std::string &Images::getValueOfKeywords() const noexcept
{
    const static std::string defaultValue = std::string();
    if(keywords_)
        return *keywords_;
...
const std::shared_ptr<std::string> &Images::getKeywords() const noexcept
{
    return keywords_;
}
void Images::setKeywords(const std::string &pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(pKeywords);
    dirtyFlag_[4] = true;
}
void Images::setKeywords(std::string &&pKeywords) noexcept
{
    keywords_ = std::make_shared<std::string>(std::move(pKeywords));
    dirtyFlag_[4] = true;
}

const std::string &Images::getValueOfUuid() const noexcept
{
    const static std::string defaultValue = std::string();
    if(uuid_)
        return *uuid_;
...
const std::shared_ptr<std::string> &Images::getUuid() const noexcept
{
    return uuid_;
}
void Images::setUuid(const std::string &pUuid) noexcept
{
    uuid_ = std::make_shared<std::string>(pUuid);
    dirtyFlag_[5] = true;
}
void Images::setUuid(std::string &&pUuid) noexcept
{
    uuid_ = std::make_shared<std::string>(std::move(pUuid));
    dirtyFlag_[5] = true;
}
void Images::setUuidToNull() noexcept
{
    uuid_.reset();
    dirtyFlag_[5] = true;
}

const int32_t &Images::getValueOfUploader() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(uploader_)
        return *uploader_;
...
const std::shared_ptr<int32_t> &Images::getUploader() const noexcept
{
    return uploader_;
}
void Images::setUploader(const int32_t &pUploader) noexcept
{
    uploader_ = std::make_shared<int32_t>(pUploader);
    dirtyFlag_[6] = true;
}
void Images::setUploaderToNull() noexcept
{
    uploader_.reset();
    dirtyFlag_[6] = true;
}

const int32_t &Images::getValueOfCollection() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(collection_)
        return *collection_;
...
const std::shared_ptr<int32_t> &Images::getCollection() const noexcept
{
    return collection_;
}
void Images::setCollection(const int32_t &pCollection) noexcept
{
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 8)
    {
        ...
        if(!pMasqueradingVector[5].empty())
        {
            if(getUuid())
            {
                ret[pMasqueradingVector[5]]=getValueOfUuid();
            }
            else
            {
...
bool Images::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("uuid"))
    {
        if(!validJsonOfField(5, "uuid", pJson["uuid"], err, true))
            return false;
    }
    if(pJson.isMember("uploader"))
    {
...
bool Images::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("uuid"))
    {
        if(!validJsonOfField(5, "uuid", pJson["uuid"], err, false))
            return false;
    }
    if(pJson.isMember("uploader"))
    {
