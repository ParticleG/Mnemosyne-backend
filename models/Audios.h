...
class Audios
{
  public:
     ...
     */
    explicit Audios(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Audios(const Json::Value &pJson) noexcept(false);
     ...
     */
    Audios(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Audios>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Audios>;
#endif
